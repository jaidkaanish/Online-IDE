...
export const saveExecution = mutation({
  ...
  handler: async (ctx, args) => {
      console.log("Selected Language:", args.language);
    ...
    const user = await ctx.db
      ...
      try {
        const selectedLanguage = args.language.toLowerCase(); // Normalize to lowercase
        ...
        console.log("Language is supported for this user.");
    } catch (error: any) {
