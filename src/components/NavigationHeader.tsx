          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/" className="flex items-center gap-3 group relative">
              ...
              <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f] p-2 rounded-xl ring-1 ring-white/10 group-hover:ring-white/20 transition-all">
                <Codesandbox className="w-6 h-6 text-orange-400 transform -rotate-6 group-hover:rotate-0 transition-transform duration-500" />
              </div>

              <div className="relative">
                <span
                  className="block text-lg font-semibold bg-gradient-to-r
                 from-orange-400 via-red-400 to-purple-400 text-transparent bg-clip-text"
                >
                  Online IDE
                </span>
                <span className="block text-xs text-white-400/60 font-medium">
                  Online Code Editor
                </span>
              </div>
            </Link>
