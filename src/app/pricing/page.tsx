        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              ...
              >
                New and efficient coding experience <br />
              </h1>
            </div>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Easy and effient coding experience with Online IDE. <br />
            </p>
          </div>
            ...
            {ENTERPRISE_FEATURES.map((feature) => (
              ...
              >
                <div className="relative">
                  <div
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500/10 to-purple-500/10 
          ...
          <div className="relative max-w-4xl mx-auto">
            <div
              className="absolute -inset-px bg-gradient-to-r from-orange-500
            ...
            <div className="relative bg-[#12121a]/90 backdrop-blur-xl rounded-2xl">
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="text-center mb-12">
                  <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-orange-500/10 to-purple-500/10 ring-1 ring-gray-800/60 mb-6">
                    <Star className="w-8 h-8 text-orange-400" />
                  </div>
                  <h2 className="text-3xl font-semibold text-white mb-4">Subscribe to Pro</h2>
                  ...
                  <p className="text-gray-400 text-lg">Unlock the full potential of Online IDE</p>
                </div>
