      ...
      <div className="bg-[#0a0a0f] rounded-xl border border-[#ffffff0a] overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-4 px-4 py-3 bg-[#080809] border-t border-[#ffffff0a]">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#FAAC34] text-white rounded-lg hover:bg-[#F89501] disabled:opacity-50 disabled:cursor-not-allowed transition-all ml-auto"
          >
            {isSubmitting ? (
              <>
                <div
